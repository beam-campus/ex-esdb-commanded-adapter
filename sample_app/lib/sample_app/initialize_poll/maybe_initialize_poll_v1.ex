defmodule SampleApp.InitializePoll.MaybeInitializePollV1 do
  @moduledoc """
  ...
  alias SampleApp.InitializePoll.{CommandV1, EventV1}
  ...
  """
  def execute(%Aggregate{poll_id: nil} = _poll, %CommandV1{} = command) do
  ...
  def execute(%Aggregate{poll_id: poll_id}, %CommandV1{}) when not is_nil(poll_id) do
