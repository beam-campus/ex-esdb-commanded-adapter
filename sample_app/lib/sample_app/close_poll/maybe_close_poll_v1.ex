defmodule SampleApp.ClosePoll.MaybeClosePollV1 do
  @moduledoc """
  ...
  alias SampleApp.ClosePoll.{CommandV1, EventV1}
  ...
  defp validate_poll_active(%Aggregate{status: :closed}), do: {:error, :poll_already_closed}
  ...
  defp validate_creator_permission(%Aggregate{} = poll, closed_by) do
    if Aggregate.created_by?(poll, closed_by) do
      :ok
    else
