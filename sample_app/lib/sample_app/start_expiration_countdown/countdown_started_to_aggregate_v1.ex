defmodule SampleApp.StartExpirationCountdown.CountdownStartedToAggregateV1 do
  @moduledoc """
  ...
  alias SampleApp.StartExpirationCountdown.EventV1
  ...
  """
  def apply(%Aggregate{} = poll, %EventV1{} = _event) do
