defmodule SampleApp.ExpireCountdown.MaybeExpireCountDownV1 do
  @moduledoc """
  ...
  alias SampleApp.ExpireCountdown.{CommandV1, EventV1}
  ...
  defp validate_poll_not_already_expired(%Aggregate{status: :expired}) do
    {:error, :poll_already_expired}
  end

  defp validate_poll_not_already_expired(_poll), do: :ok

  defp validate_expiration_time_matches(%Aggregate{expires_at: poll_expires_at}, command_expired_at) do
