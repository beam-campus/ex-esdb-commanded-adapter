...
config :regulate_greenhouse_web, RegulateGreenhouseWeb.Endpoint,
  ...
  watchers: [
    esbuild:
      {Esbuild, :install_and_run, [:regulate_greenhouse_web, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:regulate_greenhouse_web, ~w(--watch)]}
  ]
...
config :regulate_greenhouse_web, dev_routes: true
