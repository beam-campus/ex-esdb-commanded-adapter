...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/regulate_greenhouse/regulate_greenhouse.db
      """
  ...
  #
  #     config :regulate_greenhouse_web, RegulateGreenhouseWeb.Endpoint, server: true
  #
  ...
  #
  #     config :regulate_greenhouse, RegulateGreenhouse.Mailer,
  ...
  config :regulate_greenhouse, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
