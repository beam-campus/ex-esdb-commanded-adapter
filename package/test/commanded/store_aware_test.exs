defmodule ExESDB.Commanded.StoreAwareTest do
  ...
  describe "store-aware naming" do
    ...
    test "registry names are store-specific" do
      ...
      assert store1_registry ==
               :"Elixir.ExESDB.Commanded.AggregateListenerSupervisor.store1.Registry"

      assert store2_registry ==
               :"Elixir.ExESDB.Commanded.AggregateListenerSupervisor.store2.Registry"
    end
